    ...
    <div class="modal-dialog" style="position: fixed; bottom: 0; width: 100%; margin: 0;">
        <div class="modal-content bg-white text-dark">
            ...
            <div class="modal-body">
                <div style="text-align:center"><img src="/logo.png" alt="" style="width:64px;height:64px;display:block;margin:10px auto;">Pornlulu
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-12  item p-0 pr-1">
            <div class="card">
                <div class="embed-responsive embed-responsive-16by9 position-relative">
                    ...
                    <!-- <div class="imagelabel imagelabel-bottom-right"><span class="badge badge-success"><i class="fa fa-eye"></i> 314K</span></div> -->
                </div>
...
<nav aria-label="...">
    <ul class="pagination">
        <li class="page-item <?= ($page <= 1) ? "disabled" : "" ?> ">
            <a class="page-link" href="<?= $path ?>?page=<?= $page - 1 ?>" tabindex="-1">Previous</a>
        </li>
        ...
        ?>
                ...
                <li class="page-item active">
                    <a class="page-link" href="<?= $path ?>?page=<?= $i ?>"><?= $i ?> <span class="sr-only">(current)</span></a>
                </li>
