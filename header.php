...
<head>
    ...
    <meta name="csrf-token" content="VH-6aqb2D65Mozx1nfsUsqxhNEwQ-FTcxNCmwXergoA4KO4r8Jpm3C7FSj3OyEHawAwFJFOvOJapvcOyFPzYyQ==">
...
<body data-root="/" class="sidebar-mini layout-fixed layout-navbar-fixed sidebar-closed sidebar-collapse" style="height: auto;position: absolute;" cz-shortcut-listen="true">
    <div class="wrapper">

        <div id="fullPageModal" style="position: fixed; width: 100%; height: 100%; background: rgba(255,255,255, 0.93); top: 0; left: 0; display: none; z-index:10000001">
            <div style="max-width: 320px; margin: auto; text-align: center;" class="py-3">
                ...
                <img src="https://www.pornlulu.com/images/friend/0/550.webp?1699513531" alt="" style="max-width:100%;max-height:100%;" onclick="hideFullPage('http://ad.dlxdedm.com/xhz-5/#/')">
            </div>
        </div>
            ...
            <nav class=" navbar navbar-expand navbar-dark" style="background: #a00">
                ...
                <div class="d-none d-md-block" style="height: 40px; overflow: hidden">
                    <ul id="w1" class="navbar-nav mr-auto links nav">
                        <li class="nav-item"><a class="nav-link" href="/list_blog" rel="nofollow" target="_blank">Blog</a></li>
                         <li class="nav-item"><a class="nav-link" href="https://go.bbrdbr.com/?userId=5a1df9435cc16ffadd407e46bd997ea39c05cfea3c40428a9975b085cafee25f" rel="nofollow" target="_blank">裸聊美女主播</a></li>
                        <li class="nav-item"><a class="nav-link" href="https://www.hanime.xyz" rel="nofollow" target="_blank">H動漫網</a></li>
                    </ul>
                </div>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4" style="z-index: 1000001;">
            ...
            <a href="/" class="brand-link"><img class="brand-image img-circle elevation-3" src="/style/img/logo.png" alt=""> <span class="brand-text font-weight-light">Pornlulu</span> </a>
            ...
            <div class="sidebar" style="overflow-y: auto;">
                ...
                <nav class="mt-2">
                    ...
                    <ul id="w4" class="nav nav-pills nav-sidebar flex-column nav-compact nav-flat links">
                        ...
                        ?>
                            <li class="nav-item"><a class="nav-link" href="<?= str_replace('https://www.pornlulu.com', '', $row['link']) ?>"><i class="nav-icon fa fa-circle"></i>
                                    <p><?= $row['name'] ?></p>
                                </a>
                            </li>
                        <?php
